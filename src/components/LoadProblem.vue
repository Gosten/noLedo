    ...
    <div id="load-problem">
        ...
        <div class="flex-container content-container">
            ...
            <ul id="problem-list" :class="{'collapsed': listCollapsed, 'focus-transition': textInputFocus}">
                ...
                <li v-for="(problem, index) in filteredList"
                    :key="problem.name"
                    :class="{
            ...
            <transition name="button-fade">
                <div class="bottom-section preview" v-if="listCollapsed">
                    <div class="board-position-container">
    ...
    module.exports = {
        ...
        methods: {
            ...
            editProblem(){
                ...
                this.$store.commit("setEditedProblem", JSON.parse(JSON.stringify (this.selectedProblem)) )
            },
            listItemClass(index){
                return `li-${index%2}`
            },
...
<style scoped>
    ...
    .focus-transition{
        transition: .05s height ease-out !important;
    }
